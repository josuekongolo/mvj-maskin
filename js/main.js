/**
 * MVJ Maskin AS - Main JavaScript
 * Arctic Industrial Website
 */
...
(function() {
    ...
    function initContactForm() {
        ...
        contactForm.addEventListener('submit', async function(e) {
            ...
            try {
                ...
                showFormMessage('success', 'Takk for din henvendelse! Vi tar kontakt innen 24 timer.');
                contactForm.reset();
    ...
    function initScrollAnimations() {
        const animatedElements = document.querySelectorAll('.service-card, .project-card, .value-card, .area-card, .contact-card, .equipment-card');
